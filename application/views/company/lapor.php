        ...
        <div id="gambar1" class="carousel slide" data-ride="carousel">
          <div class="carousel-inner">
            ...
            <div class="carousel-item active">
              <img class="d-block w-100" src="<?php echo base_url('public/company/img/formlapor/irigasi_rusak.jpg') ?>" alt="Second slide">
            </div>
          </div>
      ...
      <div class="modal-body">
        ...
        <div id="gambar2" class="carousel slide" data-ride="carousel">
          <div class="carousel-inner">
            ...
            <div class="carousel-item active">
              <img class="d-block w-100" src="<?php echo base_url('public/company/img/formlapor/irigasi_rusak.jpg') ?>" alt="tampak samping darainase">
            </div>
          </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div id="selfi" class="carousel slide" data-ride="carousel">
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img class="d-block w-100" src="<?php echo base_url('public/company/img/formlapor/selfi_irigasi_rusak.jpg') ?>" alt="tampak samping darainase">
            </div>
          </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div id="doc" class="carousel slide" data-ride="carousel">
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img class="d-block w-100" src="<?php echo base_url('public/company/img/formlapor/pdf.png') ?>" alt="tampak samping jalan">
            </div>
            <div class="carousel-item">
              <img class="d-block w-100" src="<?php echo base_url('public/company/img/formlapor/doc.png') ?>" alt="tampak samping darainase">
            </div>
          </div>
