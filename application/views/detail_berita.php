    ...
    <div class="container">
        <div class="row">
            <div class="col-12 text-center">
                <h2 class="text-white font-weight-bold">DETAIL BERITA</h2>
                <ol class="breadcrumb">
                    <li>
        ...
        <div class="row">
            <div class="col-lg-8 py-100">
                <div class="border rounded bg-white">
                    <img class="img-fluid w-100 rounded-top" src="<?php echo base_url('') ?>/public/frontend2/images/blog/blog-single.jpg" alt="blog-image">
                    <div class="p-4">
                        ...
                        <div class="row mb-20">
                            <div class="col-sm-5 pr-sm-0 align-self-center">
                                <img class="img-fluid w-100 rounded mr-4 mb-4 mb-sm-0" src="<?php echo base_url(); ?>public/frontend2/images/blog/blog-testimonial.jpg" alt="client image">
                            </div>
                            <div class="col-sm-7">
                ...
                <div>
                    ...
                    <div class="d-flex mb-4">
                        <div class="mr-3">
                            <img class="img-fluid rounded w-100" src="<?php echo base_url(); ?>public/frontend2/images/blog/comment-1.jpg" alt="user-image">
                        </div>
                    ...
                    <div class="d-flex mb-4">
                        <div class="mr-3">
                            <img class="img-fluid rounded w-100" src="<?php echo base_url(); ?>public/frontend2/images/blog/comment-2.jpg" alt="user-image">
                        </div>
                        <div class="border rounded py-3 px-4">
                            <div class="border-bottom mb-10">
                                <h5>Mikymouse</h5>
                    ...
                    <div>
                        ...
                        <form action="#" class="row">
                            <div class="col-12">
                                <textarea name="comment" id="comment" class="form-control mb-30 p-2" placeholder="Your comment here" style="height: 180px;"></textarea>
                            </div>
                            <div class="col-lg-6">
                ...
                <div class="bg-white px-4 py-100 sidebar-box-shadow">
                    ...
                    <div class="mb-50">
                        ...
                        <div class="d-flex py-3 border-bottom">
                            <div class="mr-4">
                                <a href="blog-single.html">
                                    <img class="rounded" src="<?php echo base_url(); ?>public/frontend2/images/blog/post-thumb-sm-01.jpg" alt="post-thumb">
                                </a>
                            </div>
                            <div>
                                <h6 class="mb-3">
                        ...
                        <div class="d-flex py-3 border-bottom">
                            <div class="mr-4">
                                <a href="blog-single.html">
                                    <img class="rounded" src="<?php echo base_url(); ?>public/frontend2/images/blog/post-thumb-sm-02.jpg" alt="post-thumb">
                                </a>
                            </div>
                            <div class="content">
                                <h6 class="mb-3">
                        ...
                        <div class="d-flex py-3">
                            <div class="mr-4">
                                <a href="blog-single.html">
                                    <img class="rounded" src="<?php echo base_url(); ?>public/frontend2/images/blog/post-thumb-sm-03.jpg" alt="post-thumb">
                                </a>
                            </div>
                            <div class="content">
                                <h6 class="mb-3">
