                                    ...
                                    <?php foreach ($datakontrak as $dk) { ?>
                                        <tr>
                                            ...
                                            <td class="w-8">
                                                ...
                                                <!-- <form method="post" action="<?php // echo base_url("admin/datakontrak/delete_data_kontrak"); 
                                                                                    ?>" class="btnDeleteDatakontrak">
                                                    <input type="hidden" name="id_datakontrak" value="<?php echo $dk->id; ?>">
